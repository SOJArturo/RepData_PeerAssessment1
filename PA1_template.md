...
The 5-minute interval that contains the maximum number of steps is interval number 835.
...
```
So that the new *mean* is 10237, while the new *median* is 6971.  So we see there is a dramatic change.
